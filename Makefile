...
SOURCES = \
	__init__.py \
	fiber_layer.py fiber_layer_dialog.py

PLUGINNAME = fiber_layer

PY_FILES = \
	__init__.py \
	fiber_layer.py fiber_layer_dialog.py

UI_FILES = fiber_layer_dialog_base.ui
...
QGISDIR=C:\Users\jonah\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
